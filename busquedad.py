class Lista:
    ...
    #ysino lo encuentra retorna -1
    def busquedadLineal(self,buscado):
        pos=0
        enc=False
        lon = len(self.__lista)
        # recorre la lista hasta que la posicion sea verdadero
    ...
    def busquedaBinaria(self, buscado):
        self.ordenar("asc")
        fin = len(self.lista)-1  #guarda la posicion final del segmento lista
        inicio = 0 #guardar la posicion del segmento lista
        enc = False
